...
//    WebElement cancelBtn;
    ...
    @FindBy(id = "bfpusr__GetUserList__i__userDetails__userId_0")
    WebElement searchRecord0;
    @FindBy(xpath = "//*[@id='bfpusr__UserMgtSummary__AuthIcon_0']")
    WebElement unAuthorizedActionBtn;
    @FindBy(css = "#bfpusr__UserMgtSummary__AuthIcon_0")
    WebElement unAuthorizedIcon;
    @FindBy(id = "bfpusr__UserMgtAuthReject__el_btn_17")
    WebElement authorizeBtn;
    @FindBy(id = "bfpusr__UserMgtAuthReject__el_btn_18_txtcnt")
    WebElement rejectBtn;
    @FindBy(id = "bfpusr__UserMgtAuthReject__remark")
    WebElement remarks;
    @FindBy(xpath = "//p[contains(text(),'Do you want to authorize this record?')]")
    WebElement authPopupMsg;
    @FindBy(xpath = "//p[contains(text(),'هل تريد تفويض هذا السجل؟')]")
    WebElement authPopupArabicMsg;
    @FindBy(xpath = "//p[contains(text(),'Do you want to reject this record?')]")
    WebElement rejectPopupMsg;
    @FindBy(xpath = "//p[contains(text(),'هل تريد رفض هذا السجل؟')]")
    WebElement rejectPopupArabicMsg;
    @FindBy(xpath = "//*[text()='Status']")
    WebElement userDetail_authorized_Status;
    @FindBy(xpath = "//*[text()='حالة']")
    WebElement userDetail_authorized_StatusArabic;
    @FindBy(id = "bfpusr__UserMgtAuthReject__email_grp_lbl")
    WebElement userDetails_authorized_StatusArabic;
    @FindBy(id = "bfpusr__UserMgtSummary__userMgtSummaryTable_table")
    WebElement userSummary_table;
    @FindBy(id = "bfpusr__UserMgtSummary__status")
    WebElement statusDD;
    @FindBy(xpath = "//*[@id='bfpusr__UserMgtSummary__status_div']/ul/li")
    ...
    private static Logger LOGGER = LogManager.getLogger(UserCreation.class);
    ...
    public void isUserRejectMsgPresent(String appLanguage) throws Exception {
        utility.waitForSeconds(12);
        if (appLanguage.equalsIgnoreCase("arabic")) {
            commonElements.isElementVisible(userSucessMgArabic);
            utility.waitForSeconds(5);
            ...
            commonElements.isElementVisible(userRejectMsg);
            utility.click(okBtn);
        }
    }
    ...
    public void search_criteria_check(String mailID) throws Exception {
        utility.waitForElement(UserMngMntEmailID);
    ...
    public void is_search_Result_present() throws Exception {
        utility.waitForElement(searchRecord0);
    ...
    public void click_Authorized_searchRecord(String appLanguage) throws Exception {
        utility.waitForElement(searchRecord0);
        utility.click(searchRecord0);
        utility.waitForSeconds(4);
        if (appLanguage.equalsIgnoreCase("arabic")) {
            commonElements.isElementVisible(userDetail_authorized_StatusArabic);
            try {
                js.executeScript("arguments[0].scrollIntoView();", okBtnArabic);
                utility.click(okBtnArabic);
            } catch (Exception e) {
            ...
            try {
                js.executeScript("arguments[0].scrollIntoView();", OKTextBtn);
    ...
    public void unAuthorizedRecord_Search(String mailID, String status, String applanguage) throws Exception {
        utility.waitForElement(UserMngMntEmailID);
        commonElements.isElementVisible(UserMngMntEmailID);
        utility.sendKeys(UserMngMntEmailID, mailID);
        utility.click(statusDD);
        if (applanguage.equalsIgnoreCase("arabic")) {
            utility.selectFromDropDown(statusDDList, "غير مصرح");
        } else {
            utility.selectFromDropDown(statusDDList, status);
        }
        utility.click(searchBtn);

    }

    public void click_unauthorized_Record(String appLanguage) throws Exception {
        utility.waitForSeconds(3);
        driver.findElement(By.cssSelector("body")).sendKeys(Keys.CONTROL, Keys.END);
        commonElements.isElementVisible(searchRecord0);
        utility.waitForSeconds(3);
        try {
            commonElements.click(unAuthorizedIcon);
        } catch (Exception e) {
            javaScriptControls.executeJavaScript("arguments[0].click();", unAuthorizedActionBtn);
        }
        utility.waitForSeconds(2);
        commonElements.isElementVisible(userDetails_authorized_StatusArabic);

    }

    public void enterRemarks() throws Exception {
        utility.waitForSeconds(3);
        utility.sendKeys(remarks, "authorize or reject remark");
    }

    public void clickRejectBtn() throws Exception {
        utility.click(rejectBtn);
    }

    public void clickAthorizeBtn() throws Exception {
        utility.click(authorizeBtn);
    }

    public void authorizationPopupValidations(String appLanguage) throws Exception {
        utility.waitForSeconds(5);
        if (appLanguage.equalsIgnoreCase("arabic")) {
            commonElements.isElementVisible(authPopupArabicMsg);
            utility.click(okBtnArabic);
        } else {
            commonElements.isElementVisible(authPopupMsg);
            utility.click(okBtn);
        }
    ...
    public void rejectPopupValidations(String appLanguage) throws Exception {
        utility.waitForSeconds(5);
        if (appLanguage.equalsIgnoreCase("arabic")) {
            commonElements.isElementVisible(rejectPopupArabicMsg);
            utility.click(okBtnArabic);
        } else {
            commonElements.isElementVisible(rejectPopupMsg);
            utility.click(okBtn);
        }
        utility.waitForSeconds(6);
    }
